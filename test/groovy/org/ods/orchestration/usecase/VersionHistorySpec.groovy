...
import util.wiremock.WiremockFacade
...
class VersionHistorySpec  extends Specification {
    ...
    WiremockFacade jiraServer
    WiremockFacade docGenServer
    ...
    def setup() {
        ...
        docGenServer = loadDocGenData()
        jiraServer = loadJiraData()
        ...
        docGen = new DocGenService(docGenServer.baseUrl())
    ...
    private WiremockFacade loadDocGenData() {
        docGenServer = WiremockFactory.DOC_GEN.withScenario(this.class.name).startServer()
        // docGenServer
    ...
    private WiremockFacade loadJiraData() {
        jiraServer = WiremockFactory.DOC_GEN.build().withScenario(this.class.name).startServer()
