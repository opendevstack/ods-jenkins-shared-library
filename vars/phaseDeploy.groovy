...
def call(Map project, List<Set<Map>> repos) {
    ...
    def groups = util.prepareExecutePhaseForReposNamedJob(MROPipelineUtil.PipelinePhases.DEPLOY, repos, null) { script, repo ->
        ...
        repo.TIR = levaDoc.createTIR(script.env.RELEASE_PARAM_VERSION, project, repo)
    }
