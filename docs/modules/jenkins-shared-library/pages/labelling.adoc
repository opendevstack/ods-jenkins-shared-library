...
This label will only be set if different from app.kubernetes.io/name.
...
This default value can only be determined when first provisioning the component from a given quickstarter.
