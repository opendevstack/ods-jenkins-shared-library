...
You can increase this timeout by setting the `openshiftRolloutTimeoutMinutes` property in the `environments` section in the Release Manager repository in the `metadata.yml` file:
