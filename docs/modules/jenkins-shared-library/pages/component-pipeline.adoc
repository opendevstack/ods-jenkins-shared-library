...
include::./odsComponentPipeline.adoc[]
...
include::./odsComponentStageScanWithSonar.adoc[leveloffset=+2]

=== odsComponentStageScanWithSnyk

include::./odsComponentStageScanWithSnyk.adoc[leveloffset=+2]

=== odsComponentStageBuildOpenShiftImage

include::./odsComponentStageBuildOpenShiftImage.adoc[leveloffset=+2]

=== odsComponentStageRolloutOpenShiftDeployment

include::./odsComponentStageRolloutOpenShiftDeployment.adoc[leveloffset=+2]
