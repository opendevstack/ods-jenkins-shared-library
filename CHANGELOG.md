...
### Fixed
* Fail pipeline when deploying with issues in progress, update automatic release components ([#1256](https://github.com/opendevstack/ods-jenkins-shared-library/pull/1256))
