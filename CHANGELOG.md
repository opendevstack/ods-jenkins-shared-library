...
## Unreleased
- When using a release branch for Release Manager, no commit is now made to master branch ([#951](https://github.com/opendevstack/ods-jenkins-shared-library/pull/951))
