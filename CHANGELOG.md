...
* Fix partial TIR document history rational to invalidate only existing versions when previous project version is missing

## [4.12.1] - 2026-04-10
### Fixed
* Fix tailor issues with shared helm code ([#1270](https://github.com/opendevstack/ods-jenkins-shared-library/pull/1270))
