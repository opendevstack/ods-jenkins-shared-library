...
- Uses Nexus to store test results and jenkins job logs. Keys of tests urls sent to docGen go always in lower case. Pact Tests architecture fixed. Payload adaptions for TIP and overall TIR.
